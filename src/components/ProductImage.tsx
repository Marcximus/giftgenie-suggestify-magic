...
export const ProductImage = ({ title, imageUrl, rating, totalRatings }: ProductImageProps) => {
  ...
  useEffect(() => {
    if (currentImageUrl) {
      ...
      img.srcset = srcset;
      img.sizes = '(max-width: 768px) 100vw, 80vw';
      img.src = getOptimizedImageUrl(currentImageUrl, 900);
      ...
      nextSizeImg.src = getOptimizedImageUrl(currentImageUrl, 1200);
    }
  }, [currentImageUrl]);

  return (
    <div className="w-full space-y-4">
      <div className="aspect-[16/9] relative overflow-hidden bg-gray-100 rounded-lg">
        ...
        <img
          srcSet={currentImageUrl ? [600, 900, 1200]
            .map(width => `${getOptimizedImageUrl(currentImageUrl, width)} ${width}w`)
            .join(', ') : undefined}
          sizes="(max-width: 768px) 100vw, 80vw"
          src={currentImageUrl ? getOptimizedImageUrl(currentImageUrl, 900) : genericFallback}
