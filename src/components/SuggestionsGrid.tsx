    ...
    <>
      ...
      <div 
        className={`
          ...
          ${suggestions.length > 0 && !isLoading ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}
        `}
        role="region"
      ...
      {suggestions.length > 0 && !isLoading && (
        <div className="flex flex-col items-center mt-8 sm:mt-12 animate-in fade-in slide-in-from-bottom duration-1000 delay-500">
