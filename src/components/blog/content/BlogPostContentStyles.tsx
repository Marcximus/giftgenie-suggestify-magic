export const blogPostContentStyles = `
  prose prose-sm md:prose-base lg:prose-lg w-full max-w-none animate-fade-in
  ...
  prose-ul:list-disc prose-ul:pl-4 sm:prose-ul:pl-6 prose-ul:mb-4 prose-ul:text-left
  prose-ol:list-decimal prose-ol:pl-4 sm:prose-ol:pl-6 prose-ol:mb-4 prose-ol:text-left
