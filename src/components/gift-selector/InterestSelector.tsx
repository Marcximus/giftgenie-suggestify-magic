      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 max-w-3xl mx-auto px-4">
        {getInterests(selectedPerson, selectedAge).map((interest) => (
          <Button
            ...
            className={`transition-all duration-200 hover:scale-105 text-xs sm:text-sm h-8 sm:h-10 flex items-center ${
          ...
          >
            <span className="mr-1.5 sm:mr-2 shrink-0">{interest.icon}</span>
